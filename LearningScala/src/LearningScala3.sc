object LearningScala3 {
  ...
  def convertStringToUpperCase (s: String) : String = {
    s.toUpperCase()
  }

  def convertString (s: String, f: (String) => String) = {
    f(s)
  }

  println (convertString("aaaa", convertStringToUpperCase))
  println (convertString("bbbb", convertStringToUpperCase))

  println (convertString("cccc", s => s.toUpperCase()))
}